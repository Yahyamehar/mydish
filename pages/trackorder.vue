        ...
        <section id="dashboard-nav" class="dashboard-section">
            <div class="container">
                <ul class="dashbord-nav d-lg-flex flex-wrap align-items-center justify-content-between">
                    <li>
                        <NuxtLink to="/userdashbord"><i class="far fa-list-alt"></i>Your Orders</NuxtLink>
                    </li>
                    <li>
                        <NuxtLink to="/trackorder"><i class="fas fa-shipping-fast"></i>Track
                            Orders</NuxtLink>
                    </li>
                    <li>
                        <NuxtLink to="/userprofile"><i class="far fa-user"></i>Your Profile</NuxtLink>
                    </li>
                </ul>
            </div>
                ...
                <div class="track-order-item bg-color-white">
                    ...
                    <div class="order-details">
                        ...
                        <div class="order-details-container d-none d-md-block">
                            <div
                                class="order-details-item d-sm-flex flex-wrap text-center text-sm-left align-items-center justify-content-between">
                                <div class="thumb d-sm-flex flex-wrap align-items-center">
                                    <a onclick="openModal()"><img src="assets/images//products/cart/03.png"
                                            alt="products"></a>
                            ...
                            <div
                                class="order-details-item d-sm-flex text-center text-sm-left flex-wrap align-items-center justify-content-between">
                                <div class="thumb d-sm-flex flex-wrap align-items-center">
                                    <a onclick="openModal()"><img src="assets/images//products/cart/03.png"
                                            alt="products"></a>
                                    <div class="product-content">
                                    ...
                                    <div class="process-bar-item-inner active">
                                        ...
                                        <div class="icon-outer">
                                            <div class="icon">
                                                ...
                                                <svg viewBox="0 -10 511.98895 511" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="m314.449219 281.679688-9.414063-3.554688-21.003906 63.113281c-.617188 1.832031-1.015625 3.730469-1.183594 5.65625l-10.34375 118.503907c-1.238281 14.199218 9.925782 26.53125 24.34375 26.53125 12.519532 0 23.179688-9.578126 24.285156-22.289063l10.09375-115.601563 22.171876-65.933593c-13.261719 5.710937-28.496094 2.992187-38.949219-6.425781zm0 0" />
                                                    <path
                                                        d="m477.226562 163.757812c6.617188-14.984374-.164062-32.496093-15.148437-39.117187-9.171875-4.046875-36.242187-16.003906-48.386719-21.367187-4.699218-2.074219-9.644531-2.832032-14.429687-2.429688 1.839843 6.835938 1.3125 14.039062-1.574219 20.617188l-33.117188 75.453124 21.039063-12.382812 29.34375-43.257812-21.699219 58.582031-64.199218 37.789062c-9.296876 5.46875-12.394532 17.4375-6.925782 26.730469 5.453125 9.265625 17.414063 12.410156 26.734375 6.925781l70.191407-41.3125c3.875-2.28125 6.84375-5.828125 8.40625-10.046875l24.113281-65.101562-8.09375 71.035156c-1.507813 13.261719-13.34375 16.875-15.761719 18.835938l-59.972656 35.300781-4.089844 79.902343c-.195312 3.953126.570312 7.890626 2.234375 11.480469l49.335937 106.394531c5.667969 12.230469 20.179688 17.546876 32.410157 11.878907 12.226562-5.671875 17.546875-20.183594 11.875-32.414063l-46.800781-100.925781 2.667968-53.523437zm0 0" />
                                                    <path
                                                        d="m511.988281 63.070312c0 24.25-19.65625 43.90625-43.90625 43.90625s-43.90625-19.65625-43.90625-43.90625c0-24.246093 19.65625-43.90625 43.90625-43.90625s43.90625 19.660157 43.90625 43.90625zm0 0" />
                                                    <path
                                                        d="m185.558594 215.691406c40.871094 17.882813 119.074218 51.503906 119.074218 51.503906-6.070312-16.320312.222657-35.136718 15.753907-44.277343l21.480469-12.644531 41.703124-95.011719c3.515626-8.011719-.128906-17.355469-8.140624-20.871094l-114.5625-50.28125c-8.058594-3.535156-17.375.171875-20.871094 8.136719l-62.578125 142.574218c-3.515625 8.011719.128906 17.355469 8.140625 20.871094zm0 0" />
                                                    <path
                                                        d="m202 239.960938h-176.304688v-114.71875h165.425782c36.65625-83.261719 34.519531-79.238282 36.574218-82.671876v-29.230468c0-7.09375-5.75-12.84375-12.847656-12.84375h-202c-7.097656-.003906-12.847656 5.75-12.847656 12.84375v421.386718c0 7.09375 5.75 12.84375 12.847656 12.84375h9.960938v16.648438c0 3.527344 2.859375 6.382812 6.382812 6.382812h12.929688c3.527344 0 6.382812-2.855468 6.382812-6.382812v-16.648438h126.417969v16.648438c0 3.527344 2.855469 6.382812 6.378906 6.382812h12.933594c3.523437 0 6.378906-2.855468 6.378906-6.382812v-16.648438h14.234375c7.097656 0 12.847656-5.75 12.847656-12.84375v-183.707031l-25.695312-11.277343zm-176.304688-213.773438h176.304688v73.363281h-176.304688zm176.304688 395.691406h-176.304688v-156.222656h176.304688zm0 0" />
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
