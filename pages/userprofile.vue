        ...
        <section id="dashboard-nav" class="dashboard-section">
            <div class="container">
                <ul class="dashbord-nav d-lg-flex flex-wrap align-items-center justify-content-between">
                    <li><NuxtLink to="/userdashbord"><i class="far fa-list-alt"></i>Your Orders</NuxtLink></li>
                    <li><NuxtLink to="/trackorder"><i class="fas fa-shipping-fast"></i>Track Orders</NuxtLink></li>
                    <li><NuxtLink to="/userprofile"><i class="far fa-user"></i>Your Profile</NuxtLink></li>
                </ul>
            </div>
            ...
            <div class="container">
                <div class="dashboard-body">
                    <div class="profile">
                        <h5 class="title">Your Profile <span title="Edit Profile" id="edit" class="edit" data-toggle="modal"
                                data-target="#edit-form1"><i class="fas fa-edit"></i></span></h5>
